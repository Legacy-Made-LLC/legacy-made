...
export default function DeviceLinkingScreen() {
  ...
  const handleStartReceive = useCallback(async () => {
    ...
    try {
      ...
      pollRef.current = setInterval(async () => {
        try {
          const dekRecords = await keys.getMyDeks(
            planId,
            keyRecord.userId,
          );
   ...
   */
  const handleSendToDevice = useCallback(async (scannedCode?: string) => {
  ...
  if (isComplete) {
    return (
      <>
        <Stack.Screen options={{ title: "Link Device" }} />
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successDescription}>
            {mode === "receive"
              ? "Your encryption keys are set up. You can now access your encrypted data on this device."
              : "The new device now has access to your encrypted data."}
          </Text>
          <Pressable
  ...
  return (
    <>
      ...
      >
        {mode === "send" && (
          <>
            <Text style={styles.heading}>Authorize new device</Text>
            <Text style={styles.body}>
              Scan the QR code displayed on your new device to securely share
              your encryption access.
            </Text>
        ...
        {mode === "receive" && (
          <>
            ...
            <Text style={styles.body}>
              Generate a QR code, then scan it with your existing device to
              authorize this one.
            </Text>
              ...
              <>
                ...
                <View style={styles.warningCard}>
                  ...
                  <Text style={styles.warningText}>
                    Scan this QR code with your existing device. Your private key
                    stays on each device — only a wrapped copy of the encryption
                    key is transferred.
                  </Text>
                </View>
              </>

...
const category = categories.find((c) => c.id === 'digital')!;
...
export default function DigitalListScreen() {
    ...
    return (
      <View style={[styles.emptyContainer, { paddingBottom: insets.bottom + spacing.lg }]}>
        ...
        <Text style={styles.emptyDescription}>
          Add your important digital accounts and access information.
        </Text>
  ...
  return (
    ...
    >
      ...
      {state.digitalAccounts.map((item) => (
        <PressableCard
          key={item.id}
          ...
          <View style={styles.cardContent}>
            <View style={styles.cardText}>
              ...
              <Text style={styles.cardSubtitle}>
                {item.platform} · {importanceLabels[item.importance]}
              </Text>
            </View>

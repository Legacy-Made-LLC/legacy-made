/**
 * Family Perspective (Past Tense) - Vault Translations (en)
 *
 * Text content for the Information Vault from the family's perspective
 * when the plan owner has passed (past tense).
 */

import type { Translations } from "../../types";

export const familyPastVault: Translations["vault"] = {
  contacts: {
    ...
    tasks: {
      primary: {
        ...
        guidance:
          "These are the people they chose to call first in an emergency — people who could help coordinate what came next.",
        tips: [
          "They picked someone who lived nearby or could travel quickly if needed.",
          "These contacts knew they were the primary people to call.",
          "They chose both family members and close friends.",
        ],
      },
      backup: {
    ...
    tasks: {
      people: {
        ...
        tips: [
          ...
          "Some people might have been waiting to hear from them regularly.",
  ...
  finances: {
    ...
    tasks: {
      accounts: {
        title: "Financial Accounts",
        description: "Bank, investment, and retirement accounts",
        triggerText: "What accounts were listed?",
        guidanceHeading: "These are the accounts that existed.",
        guidance:
          "They listed enough information to contact the right institutions and locate these accounts.",
        tips: [
          "This includes checking, savings, and any investment accounts.",
          "Don't forget retirement accounts like 401(k)s and IRAs.",
          "Some accounts may have had automatic deposits or withdrawals.",
  ...
  insurance: {
    ...
    tasks: {
      policies: {
        title: "Insurance Policies",
        description: "Coverage to know about",
        triggerText: "What policies were included?",
        guidanceHeading: "These are the insurance policies that existed.",
        guidance:
        ...
        tips: [
          ...
          "Some policies may have been through their employer.",
  ...
  documents: {
    ...
    tasks: {
      legal: {
        ...
        guidance:
          "They noted where each document was stored so they could be found quickly when needed.",
        tips: [
      ...
      other: {
        ...
        triggerText: "What other records were noted?",
        guidanceHeading: "These are the records that may be needed.",
        guidance:
          "Important personal documents like birth certificates, passports, and Social Security cards are listed here. They noted where originals were stored.",
        tips: [
  ...
  property: {
    ...
    tasks: {
      property: {
        title: "Property & Vehicles",
        description: "Real estate, vehicles, and physical assets",
        triggerText: "What property was included?",
        guidanceHeading: "These are the properties and assets that existed.",
        guidance:
  ...
  pets: {
    ...
    tasks: {
      pets: {
        ...
        tips: [
          "Someone agreed in advance to care for these pets.",
    ...
    tasks: {
      email: {
        ...
        tips: [
          ...
          "They may have set up a legacy contact if their provider offered it.",
        ],
      },
      passwords: {
        ...
        guidance:
          "They noted where passwords were stored (password manager, written down, etc.) and how to access them. Actual passwords aren't stored here — just instructions on how to find them.",
        tips: [
      ...
      devices: {
        ...
        triggerText: "What devices were noted?",
      ...
      social: {
        ...
        guidance:
          "Their social media accounts and any memorialization or legacy contact settings are listed here. They noted which accounts should be deactivated or preserved.",
        tips: [
          "Many platforms offer memorialization or legacy contact options.",
          "They noted which accounts they wanted preserved vs. deleted.",
